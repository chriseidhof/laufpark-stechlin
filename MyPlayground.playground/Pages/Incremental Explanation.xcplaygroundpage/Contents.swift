...
//: The simplest incremental program we could write is one that adds two numbers. There are two important types in this library. First of all, `Input`, which represents writable variables.
...
//: The second important type is I, an incremental value. You can get an I from a Input by saying `.i`:
